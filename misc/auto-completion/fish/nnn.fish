...
complete -c nnn -s G    -d 'git status column (runs git)'
complete -c nnn -s H    -d 'show hidden files'
complete -c nnn -s i    -d 'show current file info'
complete -c nnn -s I    -d 'no directory sizes in detail'
...
complete -c nnn -s m    -d 'no permissions in detail'
...
complete -c nnn -s y    -d 'compact eza-style timestamps'
complete -c nnn -s Y    -d 'compact US timestamps (MMM DD)'
